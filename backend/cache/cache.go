...
type Cache struct {
	...
	stops   map[string][]proto.StopMonitoring
...
func New() *Cache {
	return &Cache{
		...
		stops:         make(map[string][]proto.StopMonitoring),
...
func (c *Cache) Stop(zda string) ([]proto.StopMonitoring, bool) {
	c.stopsMu.RLock()
...
func (c *Cache) UpdateStops(stops map[string][]proto.StopMonitoring) {
